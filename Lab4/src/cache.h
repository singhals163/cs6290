...
#define NUM_SAMPLED_SETS 64
#define PARTITION_INTERVAL 10000000
...
typedef struct Cache
{
    ...
    CacheSet** umon;
    uint64_t** umon_hit_counters;
    uint64_t* umon_miss_counters;
    uint64_t DWP_CORE0_WAYS;
    uint64_t last_partitioning_cycle;
